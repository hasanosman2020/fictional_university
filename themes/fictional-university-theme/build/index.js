...
class Like {
  ...
  async createLike(currentLikeBox) {
    const response = fetch(universityData.root_url + "/wp-json/university/v1/manageLikes").then(response => response.json()).then(data => console.log(data)).catch(error => console.log(error));

    /*
    try {
        const response = await axios.post(universityData.root_url + "/wp-json/university/v1/manageLikes", { "professorId":*/
    currentLikeBox.getAttribute("data-professor");
  ...
  async deleteLike(currentLikeBox) {
    const response = fetch(universityData.root_url + "/wp-json/university/v1/manageLikes", {
      ...
      body: JSON.stringify({
        "like": currentLikeBox.setAttribute("data-exists", "no")
      })
    });
...
class Search {
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchTerm.value);
